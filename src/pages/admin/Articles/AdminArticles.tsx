...
const AdminArticles: FC = () => {
    ...
    return (
        <div className="d-flex">
                        ...
                        <TableBody>
                            {articles.map((article) => (
                                <TableRow key={article.id}>
                                    ...
                                    <TableCell style={{ width: 60 }} align="right">
                                        <DeleteIcon onClick={() => handleDelete(article.id)}/>
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
            ...
            {showModal ? <CreateArticle showModal={showModal} setShowModal={setShowModal} /> : null}
            {showModalUpdate ? <UpdateArticle showModalUpdate={showModalUpdate} setShowModalUpdate={setShowModalUpdate} id={ID} /> : null}
        </div>
    )
}
